...
# 2- Repetir hasta tener una pasada completa sin swap
#count=0;
from datetime import datetime


def bubbleSort(array,count=0):
    n=len(array);
    print(f'N°: {n}');
    for i in range(n):
        cambio = True;
...
Init=datetime.now();
#num=[180,30,4,5,45,80,12,7,3,1,25,130];
"""a
num=[-796, 3229, -5164, -362, 4408, 8965, -6068, 9329, -3034, -443, -6693, 9497, 2615, -5966, -9065, -1160, 6148, 5517, 1123, -8887
...
"""
num=[3, 94, 86, 82, 90, 10, 87, 36, 61, 8, 17, 15, 22, 10, 23, 78, 25, 2, 30, 45, 98, 43, 98, 59, 53, 57, 2, 64, 1, 41,
